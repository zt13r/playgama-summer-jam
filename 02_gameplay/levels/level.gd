...
func _ready() -> void:
	...
	entity.global_position = get_tile(Vector2i(20, 16)).move_target.global_position
	...
	for x in sand_x:
		for y in tile_y:
			...
			if tile_position == sand_castle_position:
				...
				sandcastle.global_position = get_tile(tile_position).move_target.global_position
